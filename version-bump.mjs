...
let manifest = JSON.parse(readFileSync(path.resolve(__dirname, "./manifest.json"), "utf8"));
const { minAppVersion } = manifest;
manifest.version = targetVersion;
writeFileSync(path.resolve(__dirname, "./manifest.json"), JSON.stringify(manifest, null, "\t"));
